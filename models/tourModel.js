...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [30, 'A tour must have at least 30 characters'],
      // NOTE NPM VALIDATOR
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty must be either easy medium or diffiult',
      },
    },
    ratingsAverage: {
      type: Number,
      default: 4.7,
      min: [3, 'A tour must have a ratings higher than 1.0'],
      max: [5, 'A tour cannot have a ratings lower than 5.0'],
    },
    ratingsQuantity: {
      type: Number,
      default: 4,
